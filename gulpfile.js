...
exports.build = series(cleandist, pugHtml, fonts, styles, scripts, copyData, images, icons);

exports.default = parallel(pugHtml, fonts, styles, scripts, copyData, images, icons, browsersync, startwatch);